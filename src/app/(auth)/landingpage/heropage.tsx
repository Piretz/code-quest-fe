...
const Heropage = () => {
  return (
    <section
      className="bg-cover bg-center text-white text-center py-0 h-screen"
      style={{ backgroundImage: 'url(/assets/heropage-bg.png)' }} // Set the background image
    >
      {/* Flex Container for Left and Right Layout */}
      <div className="flex md:flex-row mt-0 space-y-10 md:space-y-0 px-5 md:px-8 items-center">
        
        {/* Left Side: Character Image */}
        <div className="flex justify-start w-full md:w-auto mx-auto md:mx-48">
          <Image 
        ...
        <div className="flex flex-col items-start w-full md:w-auto max-w-[600px] mx-auto md:mx-0">
