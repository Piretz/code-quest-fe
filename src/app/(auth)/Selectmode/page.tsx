...
const Page: React.FC = () => {
  ...
  <section className="fixed bottom-44 left-32 flex-col items-center mb-5">
    ...
    {/* Panel Box */}
    <div className="relative flex flex-col md:flex-row justify-center items-center font-poppins translate-y-36 w-[1700px] h-[300px] bg-gradient-to-r from-[#035CC2] to-[#073269] rounded-lg border-l border-r border-b-4 border-[#019AEC] shadow-drop-blue mx-auto">
      <div className="absolute inset-0 flex flex-col md:flex-row justify-between items-start px-8 py-2 text-white w-full h-full">
        {/* Column 1: My Courses */}
